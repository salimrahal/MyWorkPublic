...
// @LINE:14
def show(): Call = {
   Call("GET", _prefix + { _defaultPrefix } + "custom")
}
...
def show : JavascriptReverseRoute = JavascriptReverseRoute(
   ...
   """
      function() {
      return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "custom"})
      }
   """
)
...
def show(): play.api.mvc.HandlerRef[_] = new play.api.mvc.HandlerRef(
   controllers.Application.show(), HandlerDef(this, "controllers.Application", "show", Seq(), "GET", """""", _prefix + """custom""")
)
