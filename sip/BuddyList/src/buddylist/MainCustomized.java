...
//         pres2.setAddress_URI("sip:222@145.22.22.22");
        //presenceL.add(pres1);
        // presenceL.add(pres2);
        Buddy buddy1 = new Buddy("Quark", Adapter.Status.AWAY, "Away From My Nucleus (Never Idle)", null);
        Buddy buddy2 = new Buddy("Salim2", Adapter.Status.AWAY, "Away From My Nucleus (Never Idle)", null);
                ...
                try {
                    ...
                    for (Object obj : ObjArray) {
                        if (obj instanceof Buddy) {
                            ...
                            if (buddyInst.status == Adapter.Status.AWAY) {
