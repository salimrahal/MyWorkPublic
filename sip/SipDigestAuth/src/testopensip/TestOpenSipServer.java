...
public class TestOpenSipServer implements SipListener {
   ...
   public static final String UACIp = "93.185.237.237";
     ...
     */
    public TestOpenSipServer(String username) {
...
//create to header
        String username = "salimrahal";
        String address = "sip2sip.info";//"usnjpar1askvm01.us.ad.irmc.com";
...
//System.out.println("Dialog: " + dialog.getDialogId());
    ...
    public static void main(String args[]) {
        TestOpenSipServer testsip = new TestOpenSipServer("salimrahal");
        try {
