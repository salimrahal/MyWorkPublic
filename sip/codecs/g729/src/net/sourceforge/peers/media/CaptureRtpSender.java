...
public class CaptureRtpSender {
    ...
    public CaptureRtpSender(RtpSession rtpSession, SoundManager soundManager,
        ...
        try {
        	//rawDataInput = new PipedInputStream(rawDataOutput);//not working
            rawDataInput = new PipedInputStream(rawDataOutput, 960);
        } catch (IOException e) {
        ...
        try {
        	//encodedDataInput = new PipedInputStream(encodedDataOutput);//not working
            encodedDataInput = new PipedInputStream(encodedDataOutput, 20);
        } catch (IOException e) {
