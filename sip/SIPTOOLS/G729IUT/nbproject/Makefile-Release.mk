...
${OBJECTDIR}/c_code/ACELP_CO.o: c_code/ACELP_CO.C 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/ACELP_CO.o c_code/ACELP_CO.C

${OBJECTDIR}/c_code/BASIC_OP.o: c_code/BASIC_OP.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/BASIC_OP.o c_code/BASIC_OP.C

${OBJECTDIR}/c_code/BITS.o: c_code/BITS.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/BITS.o c_code/BITS.C

${OBJECTDIR}/c_code/CODER.o: c_code/CODER.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/CODER.o c_code/CODER.C

${OBJECTDIR}/c_code/COD_LD8K.o: c_code/COD_LD8K.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/COD_LD8K.o c_code/COD_LD8K.C

${OBJECTDIR}/c_code/DECODER.o: c_code/DECODER.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/DECODER.o c_code/DECODER.C

${OBJECTDIR}/c_code/DEC_GAIN.o: c_code/DEC_GAIN.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/DEC_GAIN.o c_code/DEC_GAIN.C

${OBJECTDIR}/c_code/DEC_LAG3.o: c_code/DEC_LAG3.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/DEC_LAG3.o c_code/DEC_LAG3.C

${OBJECTDIR}/c_code/DEC_LD8K.o: c_code/DEC_LD8K.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/DEC_LD8K.o c_code/DEC_LD8K.C

${OBJECTDIR}/c_code/DE_ACELP.o: c_code/DE_ACELP.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/DE_ACELP.o c_code/DE_ACELP.C

${OBJECTDIR}/c_code/DSPFUNC.o: c_code/DSPFUNC.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/DSPFUNC.o c_code/DSPFUNC.C

${OBJECTDIR}/c_code/FILTER.o: c_code/FILTER.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/FILTER.o c_code/FILTER.C

${OBJECTDIR}/c_code/GAINPRED.o: c_code/GAINPRED.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/GAINPRED.o c_code/GAINPRED.C

${OBJECTDIR}/c_code/LPC.o: c_code/LPC.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/LPC.o c_code/LPC.C

${OBJECTDIR}/c_code/LPCFUNC.o: c_code/LPCFUNC.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/LPCFUNC.o c_code/LPCFUNC.C

${OBJECTDIR}/c_code/LSPDEC.o: c_code/LSPDEC.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/LSPDEC.o c_code/LSPDEC.C

${OBJECTDIR}/c_code/LSPGETQ.o: c_code/LSPGETQ.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/LSPGETQ.o c_code/LSPGETQ.C

${OBJECTDIR}/c_code/OPER_32B.o: c_code/OPER_32B.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/OPER_32B.o c_code/OPER_32B.C

${OBJECTDIR}/c_code/PITCH.o: c_code/PITCH.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/PITCH.o c_code/PITCH.C

${OBJECTDIR}/c_code/POST_PRO.o: c_code/POST_PRO.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/POST_PRO.o c_code/POST_PRO.C

${OBJECTDIR}/c_code/PRED_LT3.o: c_code/PRED_LT3.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/PRED_LT3.o c_code/PRED_LT3.C

${OBJECTDIR}/c_code/PRE_PROC.o: c_code/PRE_PROC.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/PRE_PROC.o c_code/PRE_PROC.C

${OBJECTDIR}/c_code/PST.o: c_code/PST.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/PST.o c_code/PST.C

${OBJECTDIR}/c_code/PWF.o: c_code/PWF.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/PWF.o c_code/PWF.C

${OBJECTDIR}/c_code/P_PARITY.o: c_code/P_PARITY.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/P_PARITY.o c_code/P_PARITY.C

${OBJECTDIR}/c_code/QUA_GAIN.o: c_code/QUA_GAIN.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/QUA_GAIN.o c_code/QUA_GAIN.C

${OBJECTDIR}/c_code/QUA_LSP.o: c_code/QUA_LSP.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/QUA_LSP.o c_code/QUA_LSP.C

${OBJECTDIR}/c_code/TAB_LD8K.o: c_code/TAB_LD8K.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/TAB_LD8K.o c_code/TAB_LD8K.C

${OBJECTDIR}/c_code/UTIL.o: c_code/UTIL.C 
	${MKDIR} -p ${OBJECTDIR}/c_code
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c_code/UTIL.o c_code/UTIL.C
