...
public class AlgJPanelBck extends javax.swing.JPanel {
    ...
    public AlgJPanelBck(ClientController sipClientController) {
        initComponents();
        AlgJPanelBck.sipClientController = sipClientController;
    }
    ...
    private void runALGtestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runALGtestActionPerformed
        ...
        if (getSipClientController() == null) {
            ...
            comb1SentMsg.setCaretPosition(0);
    ...
    private static javax.swing.JTextArea comb1SentMsg;
