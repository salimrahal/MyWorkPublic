 ...
 * @author salim
 */
public class TrfDmgCallableD implements Callable<String> {
    ...
    public TrfDmgCallableD(Param param, InetAddress addressDest, int portsrc, int portdest, int clientID) throws SocketException {
        this.param = param;
