...
class HiSpeedTab$DialMetrics
{
  ...
  private HiSpeedTab$DialMetrics(String paramString)
  {
    ...
    i = HiSpeedTab.access$0((String)localHashtable.get("minidialpegs"));
    this.MINIDIALPEGDEGS = new int[i];
    this.MINIDIALPEGS = new Point[i];
    this.MINIDIALPEGALIGN = new int[i];
    for (int j = 0; j < i; j++)
    {
      this.MINIDIALPEGDEGS[j] = HiSpeedTab.access$0((String)localHashtable.get("minidialpegdegs" + j));
    ...
    j = HiSpeedTab.access$0((String)localHashtable.get("maindialpegs"));
    this.MAINDIALPEGDEGS = new int[j];
    this.MAINDIALPEGS = new Point[j];
    this.MAINDIALPEGALIGN = new int[j];
    for (int k = 0; k < j; k++)
    {
      this.MAINDIALPEGDEGS[k] = HiSpeedTab.access$0((String)localHashtable.get("maindialpegdegs" + k));
 ...
 * Qualified Name:     mcsaplugins.hispeed.HiSpeedTab.DialMetrics
