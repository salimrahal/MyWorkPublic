...
public class PresenceVO {
    ...
    public BuddyCellRenderer.Adapter.Status status;//equivalent to MSN status
    public BuddyCellRenderer.Adapter.Status_Address statusAddress;// equiv to Address status

    public BuddyCellRenderer.Adapter.Status getStatus() {
        return status;
    }

    public void setStatus(BuddyCellRenderer.Adapter.Status status) {
        this.status = status;
    }

    public BuddyCellRenderer.Adapter.Status_Address getStatusAddress() {
        return statusAddress;
    }

    public void setStatusAddress(BuddyCellRenderer.Adapter.Status_Address statusAddress) {
