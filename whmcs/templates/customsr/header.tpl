...
<div id="whmcsheader">
<p style="color: red">header.tpl</p>
  ...
  <div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container">
		...
		<ul class="nav">
			<li><a href="{if $loggedin}clientarea{else}index{/if}.php">$LANG.hometitle={$LANG.hometitle}</a></li>
		</ul>
{if $loggedin}
    <ul class="nav">
...
<p>Utilities/integration code: custom code</p>
<form method="post" action="http://localhost/whmcs/dologin.php">
<input type="hidden" name="token" value="6caf3bd93a1465bc2bc2b439078626ccac143957" />
