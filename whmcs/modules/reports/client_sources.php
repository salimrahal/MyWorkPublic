...
$result = select_query("tblcustomfieldsvalues","value,COUNT(*) AS rows","fieldid=".(int)$customfieldid." AND datecreated>='".toMySQLDate($fromdate)."' AND datecreated<='".toMySQLDate($todate)."' GROUP BY `value`","value","ASC","","tblclients ON tblclients.id=tblcustomfieldsvalues.relid");
