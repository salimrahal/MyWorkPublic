        ...
        */
        ...
        UserService serviceUser = new UserService(client);
         SearchUser searchUser = serviceUser.getSearchUser();
           System.out.println("getUsefulUsers=total count:"+searchUser.getTotalCount());//getUsefulUsers=total count: 7 for 10000 follower it works!
//        List<SearchUser> usefuluseres = serviceUser.getUsefulUsers();
