...
public class User implements Serializable {
    ...
    public String toString() {
        return "User{" + "hireable=" + hireable + ", createdAt=" + createdAt + ", collaborators=" + collaborators + ", diskUsage=" + diskUsage + ", followers=" + followers + ", following=" + following + ", id=" + id + ", ownedPrivateRepos=" + ownedPrivateRepos + ", privateGists=" + privateGists + ", publicGists=" + publicGists + ", publicRepos=" + publicRepos + ", totalPrivateRepos=" + totalPrivateRepos + ", avatarUrl=" + avatarUrl + ", bio=" + bio + ", blog=" + blog + ", company=" + company + ", email=" + email + ", gravatarId=" + gravatarId + ", htmlUrl=" + htmlUrl + ", location=" + location + ", login=" + login + ", name=" + name + ", type=" + type + ", url=" + url + ", plan=" + plan + '}';
    }
