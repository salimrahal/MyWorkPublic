...
public class GitHubClient {
    ...
    public GitHubResponse get(GitHubRequest request) throws IOException {
        ...
        /*
         SR logs
         */
        System.out.println("GitHubResponse:get(..):httpRequest.getHeaderFields()=" + httpRequest.getHeaderFields());
        System.out.println("GitHubResponse:get(..):httpRequest.getResponseCode()=" + code);
 ...
 /*
         SR logs
         */
        System.out.println("gitHubClient:updateRateLimits=request.getHeaderField(\"X-RateLimit-Limit\")=" + limit+"/X-RateLimit-Remaining="+remainingRequests);
    ...
    public String toString() {
        return "GitHubClient{" + "baseUri=" + baseUri + ", prefix=" + prefix + ", gson=" + gson + ", user=" + user + ", credentials=" + credentials + ", userAgent=" + userAgent + ", headerAccept=" + headerAccept + ", bufferSize=" + bufferSize + ", requestLimit=" + requestLimit + ", remainingRequests=" + remainingRequests + '}';
    }
