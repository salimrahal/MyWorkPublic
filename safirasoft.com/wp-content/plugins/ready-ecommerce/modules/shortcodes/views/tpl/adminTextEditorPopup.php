...
var toeShortCodesData = <?php echo utils::jsonEncode($this->shortcodes)?>;
...
<?php echo html::formStart('toeInsertShortcodeForm', array('attrs' => 'id="toeInsertShortcodeForm"'))?>
    <div id="toeInsertShortcodeSelectBox">
        <h3><a href="#"><?php lang::_e('Shortcode')?></a></h3>
        <div id="toeInsertShortcodeContentDefault">
            <div><?php lang::_e('Type')?>: <?php echo html::selectbox('shortcodeType', array('options' => $this->shortcodesSelectOptions))?></div>
            <div class="toeInsertShortcodeAtts"></div>
        </div>
        <h3><a href="#" title="category"><?php lang::_e('Category')?></a></h3>
        <div>
            <div class="toeInsertShortcodeAtts"></div>
        </div>
        <h3><a href="#" title="product"><?php lang::_e('Product')?></a></h3>
        <div>
            <div class="toeInsertShortcodeAtts"></div>
        </div>
    </div>
    <div>
        <?php echo html::hidden('newContent')?>
        <?php echo html::submit('insert', array('value' => lang::_('Insert')))?>
    </div>
