...
class PC_Shortcodes {
	...
	public function __construct($selected_shortcodes = null, $mode = 'add' ) {
		...
		/* Use a custom [gallery] shortcode to always use the link to the image if fancybox enabled. If we don't do this then image links to attachment pages get messed up. If Fancybox not used then use the default WP [gallery] shortcode. */
