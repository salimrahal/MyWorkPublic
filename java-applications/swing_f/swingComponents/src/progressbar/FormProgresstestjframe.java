 ...
 * @author salim
 */
public class FormProgresstestjframe extends javax.swing.JFrame implements PropertyChangeListener {
    
private TaskL task;
    /**
     * Creates new form formProgress
     */
    public FormProgresstestjframe() {
        initComponents();
    }
 ...
 //setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormProgresstestjframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormProgresstestjframe().setVisible(true);
            }
        });
    }
